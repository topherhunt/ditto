...
const content = loadContent(process.env.CONTENT_DIR ?? join(root, "content"), process.env.AUDIO_DIR ?? join(root, "content/audio"), { audio: process.argv.includes("--require-audio") ? "require" : "warn" });
